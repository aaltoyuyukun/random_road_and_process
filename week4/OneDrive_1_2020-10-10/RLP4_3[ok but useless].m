...
mu = 0;
sigma = 1;
pd = makedist('Normal','mu',mu,'sigma',sigma); % probability distribution
y1 = cdf(pd,sumL); % cfd is distribution function
y2 = cdf(pd,sumR); % CDF = Cumulative distribution function
